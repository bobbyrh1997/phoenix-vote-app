defmodule VoteApp.Auth.Login do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, VoteApp.Repo)
  ...
  @doc """
  A login changeset for changing the password.
  ...
  If there is no login or the login doesn't have a password, we call
  `Bcrypt.no_user_verify/0` to avoid timing attacks.
  """
  def valid_password?(%VoteApp.Auth.Login{hashed_password: hashed_password}, password)
