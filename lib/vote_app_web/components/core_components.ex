defmodule VoteAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VoteAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VoteAppWeb.Gettext, "errors", msg, opts)
    end
  end
