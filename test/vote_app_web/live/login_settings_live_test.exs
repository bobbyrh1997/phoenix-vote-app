defmodule VoteAppWeb.LoginSettingsLiveTest do
  ...
  describe "update email form" do
    ...
    test "updates the login email", %{conn: conn, password: password, login: login} do
      ...
      assert Auth.get_login_by_email(login.email)
    end
  ...
  describe "update password form" do
    ...
    test "updates the login password", %{conn: conn, login: login, password: password} do
      ...
      assert Auth.get_login_by_email_and_password(login.email, new_password)
    end
  ...
  describe "confirm email" do
    ...
    test "updates the login email once", %{conn: conn, login: login, token: token, email: email} do
      ...
      refute Auth.get_login_by_email(login.email)
      assert Auth.get_login_by_email(email)
